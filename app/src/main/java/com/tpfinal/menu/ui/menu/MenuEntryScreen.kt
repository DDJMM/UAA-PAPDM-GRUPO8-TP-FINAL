...
object MenuEntryDestination : NavigationDestination {
...
fun MenuEntryScreen(
    ...
    viewModel: MenuEntryViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
    val coroutineScope = rememberCoroutineScope()
    Scaffold(
        topBar = {
            MenuTopAppBar(
                title = stringResource(MenuEntryDestination.titleRes),
